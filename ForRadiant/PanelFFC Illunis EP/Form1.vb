...
Public Class PanelFFCIllunisEP
    ...
    Private Function Calculate(list1 As List(Of List(Of Double)), list2 As List(Of List(Of Double)), list3 As List(Of List(Of Double)), list4 As List(Of List(Of Double)), mlist As List(Of List(Of Double))) As List(Of List(Of Double))
        ...
        For row As Integer = 0 To rowlength - 1
            ...
            For column As Integer = 0 To columnlength - 1
                ...
                tempvalue = mlist(row)(column) / (list1(row)(column) + list2(row)(column) + list3(row)(column) + list4(row)(column))
                values.Add(tempvalue)
            Next
    ...
    Private Sub GenerateXML(ByVal camerasn As String, ByVal color As String, ByVal outputfile As String) 'this function is to generate the xml based on the template below
        ...
        xmlfile.WriteLine("  <NormalFileName>EP_" + camerasn + ".csv</NormalFileName>")
        ...
        xmlfile.WriteLine("  <VerticalGradient> </VerticalGradient>")
        xmlfile.WriteLine("  <HorizontalGradient>0, 0</HorizontalGradient>")
        xmlfile.WriteLine("  <Vignetting> </Vignetting>")
    ...
    Private Sub PanelFFCIllunisEP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        SetVersionInfo()
    End Sub
End Class
