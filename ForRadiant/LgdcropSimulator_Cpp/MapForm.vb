...
Public Class MapForm
    ...
    Public Property CalIMG As String
    ...
    Private Sub BtnOK_Click(sender As Object, e As EventArgs) Handles BtnOK.Click
        ...
        CalIMG = Path.Combine(assemblyPath, "InputIMG" + LGDCropModel, txtCalImage.Text & ".tif")
        Dim ImgArr12(,) As Single = ScaleAndRotateImageArray(CalIMG)
        Dim ImgArr12Ushort(,) As UShort = ConvertDataArrayToJaggedShortArray(ImgArr12, txtCalImage.Text)
