...
Namespace AutoDeleteData
    Partial Public Class MainForm
        ...
        Private Sub LoadAllMonitorList()
            Dim CSVFilePathName = "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\foldermonitorlist.csv"
            Dim Lines() As String
            If File.Exists(CSVFilePathName) Then
                ...
                Catch ex As Exception
                    MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\foldermonitorlist.csv is in use, cannot load saved list")
                    Lines = New String() {
                        "D:\Program\RVS\InputLog,3600,3,0,",
                        "D:\Program\RVS\UploadQueue\Log,3600,3,0,",
                        "D:\Program\RVS\TrueTestWatcherLog,3600,3,0,",
                        "D:\Program\RVS\AutoDeleteDataLog,3600,3,0,",
                        "D:\POCB\Hex,3600,3,0,",
                        "E:\POCB\Hex,3600,3,0,",
                        "F:\POCB\Hex,3600,3,0,",
                        "G:\POCB\Hex,3600,3,0,",
                        "D:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,3600,3,0,",
                        "D:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,3600,3,0,",
                        "E:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,3600,3,0,",
                        "E:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,3600,3,0,",
                        "D:\Test,3600,3,0,"}
                End Try
            ...
            Dim Fields() = "Delete Path, Delete Wait (s), Delete Period (days), Sub Folder Level, Next Run Countdown (s)".Split(",")
            ...
            Dim CSVFilePathName2 = "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist.csv"
            ...
            If File.Exists(CSVFilePathName2) Then
                ...
                Catch ex As Exception
                    MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist.csv is in use, cannot load saved list")
                    Lines2 = New String() {
                        "C,60,30,",
                        "D,60,30,",
                        "E,60,30,",
            ...
            Dim CSVFilePathName3 = "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist2.csv"
            ...
            If File.Exists(CSVFilePathName3) Then
                ...
                Catch ex As Exception
                    MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist2.csv is in use, cannot load saved list")
                    Lines3 = New String() {
                        "C:\POCB\Hex,0",
                        "D:\POCB\Hex,0",
                        "E:\POCB\Hex,0",
                        ...
                        "G:\POCB\Hex,0",
                        "H:\POCB\Hex,0",
                        "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\AutoGenerated\DB1,0",
                        "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\AutoGenerated\DB2,0",
                        "D:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "D:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0",
                        "E:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "E:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0",
                        "F:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "F:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0",
                        "G:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "G:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0",
                        "H:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "H:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0"
                        }
                End Try
            ...
            Dim Fields3() = "Delete Path, Sub Folder Level".Split(",")
        ...
        Private Sub DeleteCurrentWithSize(foldersToDelete As List(Of String), TargetAvailableFreeSpaceInGB As Double, subfolderlevelsToDelete As List(Of Integer), logpath As String)

            ' Recursively delete files in all subdirectories and delete empty directories
            DeleteOldestFilesAndSubfolders(foldersToDelete, TargetAvailableFreeSpaceInGB, subfolderlevelsToDelete, logpath)
        ...
        Private Sub DeleteCurrentAtPeriod(path As String, period As Integer, subfolderlevel As Integer, logpath As String)
        ...
        Sub DeleteOldestFilesAndSubfolders(ByVal foldersToDelete As List(Of String), ByVal targetSizeGB As Double, ByVal subfolderlevelsToDelete As List(Of Integer), ByVal logpath As String)
            ...
            For i As Integer = 0 To foldersToDelete.Count - 1
                Dim folderPath As String = foldersToDelete(i)
                Dim levelToDelete As Integer = subfolderlevelsToDelete(i)

                Try
                    Dim directory As New DirectoryInfo(folderPath)
                    If directory.Exists Then
                        ' Log the folder path and the subfolder level to debug
                        WriteLog(logpath, Now.ToString("yyyyMMdd HH:mm:ss") + $" : Processing folder '{folderPath}' with subfolder level {levelToDelete}." + Environment.NewLine)

                        ' Collect files and folders based on the specified subfolder level
                        allFiles.AddRange(GetAllFilesAndFolders(directory, levelToDelete))
                    Else
                        WriteLog(logpath, $"Directory not found: {folderPath}." + Environment.NewLine)
                    End If
                Catch ex As Exception
                    ' Log the exception or handle it as needed
                    WriteLog(logpath, $"Error processing folder {folderPath}: {ex.Message}." + Environment.NewLine)
                End Try
            Next
            ...
            For Each item As FileSystemInfo In allFiles
                Try
                    If TypeOf item Is FileInfo Then
                        ...
                        If ShouldStopDeleting(file, excludedFolderNames, excludedFolderPaths, excludedFilesNames, logpath) Then
            ...
            For Each folder As DirectoryInfo In emptiedFolders
                DeleteEmptyParentFolders(folder, foldersToDelete, excludedFolderNames, logpath)
            Next
        End Sub
        ...
        Sub DeleteEmptyParentFolders(ByVal folder As DirectoryInfo, ByVal foldersToDelete As List(Of String), ByVal excludeFolders As List(Of String), logpath As String)
            ...
            If DirectoryIsEmpty(folder) Then
                ...
                End Try
            Else
                WriteLog(logpath, Now.ToString("yyyyMMdd HH:mm:ss") + $" : Skipped deleting non-empty folder: {folder.FullName}" + Environment.NewLine)
            End If
        End Sub


        Private Function GetAllFilesAndFolders(directory As DirectoryInfo, level As Integer) As List(Of FileSystemInfo)
            Dim filesAndFolders As New List(Of FileSystemInfo)
        ...
        Private Sub startMonitor()
            ...
            txtExcludeFolderPaths.Enabled = False
            ...
            btnEnableEditExcludePathList.Invoke(Sub()
                                                    btnEnableEditExcludePathList.Enabled = False
                                                End Sub)

            btnSaveList5.Invoke(Sub()
                                    btnSaveList5.Enabled = False
                                End Sub)

            btnReloadList5.Invoke(Sub()
                                      btnReloadList5.Enabled = False
                                  End Sub)
        ...
        Private Sub stopMonitor()
            ...
            txtExcludeFolderPaths.Enabled = True
            ...
            btnEnableEditExcludePathList.Invoke(Sub()
                                                    btnEnableEditExcludePathList.Enabled = True
                                                End Sub)

            btnSaveList5.Invoke(Sub()
                                    btnSaveList5.Enabled = True
                                End Sub)

            btnReloadList5.Invoke(Sub()
                                      btnReloadList5.Enabled = True
                                  End Sub)
        ...
        Private Sub btnDelSelectedFolder_Click(sender As Object, e As EventArgs) Handles btnDelSelectedFolder.Click
            If dataGridView1 IsNot Nothing Then
                ...
                Else
                    logpath = appdir + "\Log\autodeletedatalog_" + path.Replace("\", "-").Replace(":", "") + "_" + Now.ToString("yyyyMMdd") + ".txt"
                End If
                Dim DeleteTask = New Tasks.Task(New Action(Sub() DeleteCurrentAtPeriod(path, period, subfolderlevel, logpath)))
                DeleteTask.Start()
            End If
        End Sub
        ...
        Private Sub SaveAllMonitorList()
            ...
            Try
                Using sw As New IO.StreamWriter("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\foldermonitorlist.csv")
                    For Each r In rows
                ...
                End Using
            Catch ex As Exception
                MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\foldermonitorlist.csv is in use, cannot save list")
            End Try
            ...
            Dim rows2 = From row As DataGridViewRow In dataGridView2.Rows.Cast(Of DataGridViewRow)()
                        ...
                        Select Array.ConvertAll(row.Cells.Cast(Of DataGridViewCell).ToArray, Function(c) If(c.Value IsNot Nothing, c.Value.ToString, ""))
            Try
                Using sw As New IO.StreamWriter("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist.csv")
                    For Each r In rows2
                        'Dim skip As Boolean = False
                        'For Each item As String In r
                        '	If String.IsNullOrEmpty(item) Or String.IsNullOrWhiteSpace(item) Then
                ...
                End Using
            Catch ex As Exception
                MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist.csv is in use, cannot save list")
            End Try
            ...
            Dim rows3 = From row As DataGridViewRow In dataGridView3.Rows.Cast(Of DataGridViewRow)()
                        ...
                        Select Array.ConvertAll(row.Cells.Cast(Of DataGridViewCell).ToArray, Function(c) If(c.Value IsNot Nothing, c.Value.ToString, ""))
            Try
                Using sw As New IO.StreamWriter("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist2.csv")
                    For Each r In rows3
                        'Dim skip As Boolean = False
                        'For Each item As String In r
                        '	If String.IsNullOrEmpty(item) Or String.IsNullOrWhiteSpace(item) Then
                ...
                End Using
            Catch ex As Exception
                MessageBox.Show("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\diskmonitorlist2.csv is in use, cannot save list")
            End Try
        End Sub
        ...
        Sub SaveExcludedFileNames()
            Try
                ...
                File.WriteAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_files.txt", txtExcludeFileNames.Text)
            Catch ex As Exception
        ...
        Sub SaveExcludedFolderNames()
            Try
                ' Write the text from the text box to the specified file
                File.WriteAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_folders.txt", txtExcludeFolderNames.Text)
            Catch ex As Exception
                ' Handle the exception if writing fails
                MessageBox.Show("Error writing text box lines to file: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        ...
        Sub SaveExcludedFolderPaths()
            Try
                ' Write the text from the text box to the specified file
                File.WriteAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_paths.txt", txtExcludeFolderPaths.Text)
            Catch ex As Exception
                ' Handle the exception if writing fails
                MessageBox.Show("Error writing text box lines to file: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        ...
        Sub LoadExcludedFileNames()
            If File.Exists("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_files.txt") Then
                Try
                    ' Read all lines from the file and set them as the text of the text box
                    txtExcludeFileNames.Text = File.ReadAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_files.txt")
                Catch ex As Exception
        ...
        Sub LoadExcludedFolderNames()
            If File.Exists("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_folders.txt") Then
                Try
                    ' Read all lines from the file and set them as the text of the text box
                    txtExcludeFolderNames.Text = File.ReadAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_folders.txt")
                Catch ex As Exception
                    ' Handle the exception if reading fails
                    MessageBox.Show("Error loading lines from file to text box: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Try
        ...
        Sub LoadExcludedFolderPaths()
            If File.Exists("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_paths.txt") Then
                Try
                    ' Read all lines from the file and set them as the text of the text box
                    txtExcludeFolderPaths.Text = File.ReadAllText("C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_exclude_paths.txt")
                Catch ex As Exception
                    ' Handle the exception if reading fails
                    MessageBox.Show("Error loading lines from file to text box: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Try
        ...
        Sub SaveCreationSetting()
            Try
                ...
                Dim settingsFilePath As String = "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoDelete\autodelete_creation_settings.txt"
        ...
        Private Sub btnEnableEditExcludePathList_Click(sender As Object, e As EventArgs) Handles btnEnableEditExcludePathList.Click
            ' Toggle the read-only state of the TextBox
            txtExcludeFolderPaths.ReadOnly = Not txtExcludeFolderPaths.ReadOnly

            ' Change the button text based on the read-only state of the TextBox
            If txtExcludeFolderPaths.ReadOnly Then
                btnEnableEditExcludePathList.Text = "Edit List"
            Else
                btnEnableEditExcludePathList.Text = "Done Editing"
            End If
        End Sub

        Private Sub btnSaveList5_Click(sender As Object, e As EventArgs) Handles btnSaveList5.Click
            SaveExcludedFolderPaths()
        End Sub

        Private Sub btnReloadList5_Click(sender As Object, e As EventArgs) Handles btnReloadList5.Click
            LoadExcludedFolderPaths()
        End Sub
    End Class
End Namespace
