            ...
            If File.Exists(CSVFilePathName3) Then
                ...
                Catch ex As Exception
                    ...
                    Lines3 = New String() {
                        ...
                        "G:\POCB\Hex,0",
                        "H:\POCB\Hex,0",
                        "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB1,0",
                        "C:\Radiant Vision Systems Data\TrueTest\UserData\AutoGenerated\DB2,0",
            ...
            For Each item As FileSystemInfo In allFiles
                Try
                    ...
                    ElseIf TypeOf item Is DirectoryInfo Then
                        ...
                        If DirectoryIsEmpty(directory) AndAlso Not IsFolderInPathExcluded(directory, excludedFolderNames) AndAlso Not foldersToDelete.Contains(directory.FullName) Then
                            ' Check if the checkbox is checked
                            If chkSkipFolderLastCreationTime.Checked Then
