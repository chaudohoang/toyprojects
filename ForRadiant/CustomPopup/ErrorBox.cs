...
namespace CustomPopup
{
    public partial class ErrorBox : Form
    {
        ...
        public ErrorBox()
        {
            ...
            //DialogResult result = ErrorBox.Show("Are you sure you want to exit?", "Exit", ErrorBox.Buttons.YesNoCancel, ErrorBox.Icon.Shield, ErrorBox.AnimateStyle.FadeIn);
        ...
        public static DialogResult ShowDialog(string message, string title, Buttons buttons)
        {
            _errorBox = new ErrorBox();
            _errorBox._lblMessage.Text = message;
            _errorBox._lblTitle.Text = title;
        ...
        public static DialogResult ShowDialog(string message, string title, Buttons buttons, Icon icon)
        {
            _errorBox = new ErrorBox();
            _errorBox._lblMessage.Text = message;
            _errorBox._lblTitle.Text = title;
        ...
        public static DialogResult ShowDialog(string message, string title, Buttons buttons, Icon icon, AnimateStyle style)
        {
            _errorBox = new ErrorBox();
            _errorBox._lblMessage.Text = message;
            _errorBox._lblTitle.Text = title;
