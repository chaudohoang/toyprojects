' =============================================================================
' UI.vb — Fixture_Company_Server_Simulator
'
...
'   Server.vb         — TCP networking (listen, receive, send)
...
Partial Public Class ServerSimulatorForm
    ...
    Private lbxLog            As ListBox   ' Written to by Log() in Server.vb
    ...
    Private Sub BuildUI()
        Me.Text          = "Fixture Company  —  Server Simulator"
        ...
        Dim lblIP As New Label With {.Text = "Listen IP:", .AutoSize = True, .Location = New Point(10, 17)}
        ...
        btnListen = New Button With {
            .Text = "Start Listening", .Width = 118, .Height = 26, .Location = New Point(313, 12),
        ...
        lblStatus = New Label With {
            .Text = "●  Idle", .AutoSize = True, .Location = New Point(545, 17),
            .ForeColor = Color.Gray, .Font = New Font("Segoe UI", 9, FontStyle.Bold)
        }
        pnlConn.Controls.AddRange({lblIP, txtIP, lblPort, txtPort, btnListen, btnDisconnect, lblStatus})
        ...
        AddHandler btnListen.Click,        AddressOf OnListenClick
    ...
    Public Sub SetListeningState()
        If InvokeRequired Then BeginInvoke(Sub() SetListeningState()) : Return
        btnListen.Enabled     = False : btnDisconnect.Enabled = True : btnSend.Enabled = False
        txtIP.Enabled         = False : txtPort.Enabled = False
        lblStatus.Text        = "●  Listening…" : lblStatus.ForeColor = Color.DarkOrange
    End Sub
    ...
    Public Sub SetConnectedState(connected As Boolean)
        ...
        btnListen.Enabled     = Not connected : btnDisconnect.Enabled = connected : btnSend.Enabled = connected
        txtIP.Enabled         = Not connected : txtPort.Enabled = Not connected
        lblStatus.Text        = If(connected, "●  Client Connected", "●  Idle")
