' =============================================================================
' EventHandlers.vb — Fixture_Company_Server_Simulator
'
...
Partial Public Class ServerSimulatorForm
    ...
    Private Sub OnListenClick(sender As Object, e As EventArgs)
        Dim port As Integer
        If Not Integer.TryParse(txtPort.Text.Trim(), port) Then
            ...
            Return
        End If
        StartListening(txtIP.Text.Trim(), port)   ' → Server.vb
    End Sub

    Private Sub OnDisconnectClick(sender As Object, e As EventArgs)
        StopServer()   ' → Server.vb
    End Sub
