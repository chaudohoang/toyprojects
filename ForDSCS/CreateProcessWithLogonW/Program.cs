...
namespace CreateProcessWithLogonW
{
    class Program
    {
        ...
        {
            string filename, domain, user, pass;

            filename = "Network Presentation.exe";
            domain = "";
            user = "damenadmin";
            pass = "M7D6mexSHe0y";
            ...
            {
                string runtimehash = checkOrigin(filename);

                if (runtimehash == "8a2a945f21b8deac4dc93c9591a5e4ba46bbcf3b0be9a2615541cb6ba7746ec6")
                    try
                    {
                ...
                else Console.WriteLine("Incorrect application file . . .");
